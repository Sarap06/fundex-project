export default function AuthLoading() {
  return (
    <div className="relative min-h-screen bg-white font-sans flex items-center justify-center p-4">
      ...
      <div className="relative z-10 rounded-2xl border border-stone-100 bg-white shadow-sm p-8 max-w-md w-full text-center">
        <div className="flex items-center justify-center gap-3">
          <div className="h-5 w-5 animate-spin rounded-full border-2 border-fundex-gold border-t-transparent" />
