  ...
  return (
    <div className={`min-h-screen bg-gray-50 transition-all duration-300 ${
      ...
      <header className={`bg-green-600 fixed top-0 right-0 z-30 transition-all duration-300 border-b border-green-700 ${
        ...
        <div className="px-8 py-5 flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-green-100">Manage your deal pipeline</p>
          </div>
          <button
      ...
      <main className="pt-20 px-8 py-8">
        <DashboardNav activeTab="deals" onTabChange={handleTabChange} isExpanded={isExpanded} onExpandChange={setIsExpanded} />
      {/* KPI Cards */}
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <Card className="border-gray-200 hover:shadow-md transition-shadow">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Total Contracts</p>
        ...
        <Card className="border-green-200 bg-gradient-to-br from-green-50 to-white hover:shadow-md transition-shadow">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs font-semibold text-green-700 uppercase tracking-wide">Active Contracts</p>
              <TrendingUp className="size-4 text-green-500" />
            </div>
            <p className="text-3xl font-bold text-green-600">{activeDeals}</p>
            <p className="text-xs text-green-600 mt-1">Generating interest</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-gray-200 hover:shadow-md transition-shadow">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Closed Contracts</p>
              <TrendingUp className="size-4 text-gray-400" />
            </div>
            <p className="text-3xl font-bold text-gray-900">{closedDeals}</p>
            <p className="text-xs text-gray-500 mt-1">Matured or repaid</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-white hover:shadow-md transition-shadow">
          <CardContent className="p-5">
            ...
            <p className="text-3xl font-bold text-purple-600">{formatCurrency(calculateTotalMonthlyInterest())}</p>
      ...
      {isFilterPanelOpen && (
        <div ref={filterPanelRef} className="mb-6 p-5 bg-white border border-gray-200 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-5">
            {/* Contract Status */}
            <div>
              <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-3">Contract Status</h4>
            ...
            {/* Deal Type */}
            <div>
              <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-3">Deal Type</h4>
              <div className="space-y-2">
            ...
            {/* Location */}
            <div>
              <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-3">Location</h4>
              <div className="space-y-2">
                <Input
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {/* Interest Rate Range */}
            <div>
              <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-3">Interest Rate (%)</h4>
              <div className="space-y-2">
                <Input
                  type="number"
                  placeholder="Min"
            ...
            <div>
              <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-3">Capital Raised ($)</h4>
              <div className="space-y-2">
                <Input
                  type="number"
                  placeholder="Min"
          ...
          <div className="flex gap-3 justify-end mt-5 pt-5 border-t border-gray-200">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Deal ID</th>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Target / Raised</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Progress</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Rate</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Investors</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Close Date</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase">Milestone</th>
            ...
            <tbody>
              {filteredDeals.map((deal) => (
                <tr key={deal.id} className="border-b border-gray-200 hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{deal.type}</td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{deal.interest_rate}%</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{deal.investor_count}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{deal.close_date ? new Date(deal.close_date).toLocaleDateString() : 'N/A'}</td>
                  <td className="px-6 py-4">
                    {deal.next_milestone && (
