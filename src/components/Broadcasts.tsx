      ...
      <div className="space-y-6 pt-6">
          ...
          <div className="flex gap-3 items-center">
            ...
            {isAdmin && (
              <button 
                ...
                className="bg-green-600 text-white px-4 py-3 rounded-lg font-semibold hover:bg-green-700 transition whitespace-nowrap"
              >
        ...
        {isAdmin && showSendForm && (
          <div className="fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-300 pointer-events-none">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-300 pointer-events-auto">
              {/* Modal Header */}
                    ...
                    {!file ? (
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition">
                        ...
                        <label htmlFor="file-input" className="cursor-pointer">
                          ...
                          <p className="text-xs text-gray-500">PDF, DOC, DOCX, XLSX, PPT, TXT, JPG, PNG, ZIP (max 10MB)</p>
                        </label>
                      </div>
                    ) : (
            ...
            {filteredBroadcasts.map((broadcast) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md hover:border-green-200 transition cursor-pointer"
                >
                  <div className="flex gap-4 items-start">
                    {/* Avatar */}
                    <div className="flex-shrink-0 w-14 h-14 rounded-full flex items-center justify-center text-white font-bold text-lg bg-gradient-to-br from-green-500 to-green-600">
                      {initials}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4 mb-1">
                        <div>
                          <h3 className="font-bold text-gray-900 text-base">{broadcast.title}</h3>
          ...
          <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">{expandedBroadcast.title}</h1>
            ...
            {expandedBroadcast.file_url && expandedBroadcast.file_name && (
              <div className="mb-8">
                ...
                <div className="bg-white border-2 border-green-200 rounded-lg p-6 flex items-center justify-between hover:shadow-md transition">
                  <div className="flex items-center gap-4">
                    <div className="bg-green-100 p-4 rounded-lg">
                      <FileIcon className="text-green-600" size={32} />
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900">{expandedBroadcast.file_name}</p>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-green-600 text-white hover:bg-green-700 rounded-lg transition font-medium whitespace-nowrap"
                  >
                    <Download size={20} />
                    Download
                  </button>
