...
export function Services() {
  const data = [
    ...
    title: "Investor Management",
      content: (
        <div>
          <p className="font-body text-muted-foreground text-sm md:text-base mb-6 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-card clean-border rounded-xl p-5">
              <Building2 className="w-6 h-6 mb-3" style={{ color: 'var(--accent-emerald)' }} />
              <h4 className="font-display font-bold text-foreground mb-1">Up to $25M</h4>
              <p className="font-body text-muted-foreground text-sm">Per transaction</p>
            </div>
            <div className="bg-card clean-border rounded-xl p-5">
              <TrendingUp className="w-6 h-6 mb-3" style={{ color: 'var(--accent-emerald)' }} />
              <h4 className="font-display font-bold text-foreground mb-1">7-Day Close</h4>
              <p className="font-body text-muted-foreground text-sm">Average turnaround</p>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-card clean-border rounded-xl p-5">
              <Shield className="w-6 h-6 mb-3" style={{ color: 'var(--accent-emerald)' }} />
              <h4 className="font-display font-bold text-foreground mb-1">Up to 90% LTC</h4>
              <p className="font-body text-muted-foreground text-sm">Loan-to-cost ratio</p>
            </div>
            <div className="bg-card clean-border rounded-xl p-5">
              <Banknote className="w-6 h-6 mb-3" style={{ color: 'var(--accent-emerald)' }} />
              <h4 className="font-display font-bold text-foreground mb-1">100% Rehab</h4>
              <p className="font-body text-muted-foreground text-sm">Construction costs covered</p>
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-card clean-border rounded-xl p-5">
              <BarChart3 className="w-6 h-6 mb-3" style={{ color: 'var(--accent-emerald)' }} />
              <h4 className="font-display font-bold text-foreground mb-1">No Tax Returns</h4>
              <p className="font-body text-muted-foreground text-sm">Qualify on rental income</p>
            </div>
            <div className="bg-card clean-border rounded-xl p-5">
              <Users className="w-6 h-6 mb-3" style={{ color: 'var(--accent-emerald)' }} />
              <h4 className="font-display font-bold text-foreground mb-1">30-Year Terms</h4>
              <p className="font-body text-muted-foreground text-sm">Fixed & adjustable rates</p>
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-10">
          <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black leading-tight text-foreground uppercase tracking-tight">
            Platform <span style={{ color: 'var(--accent-emerald)' }}>Capabilities</span>
          </h2>
