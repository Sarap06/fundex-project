...
export function WhyFundex() {
  const reasons = [
    { icon: <Zap className="w-6 h-6" style={{ color: 'var(--accent-emerald)' }} />, title: 'Speed to Close', description: 'Our infrastructure eliminates bottlenecks. Go from application to funded in days, not months.' },
    { icon: <TrendingUp className="w-6 h-6" style={{ color: 'var(--accent-emerald)' }} />, title: 'Scale Without Limits', description: 'Whether you manage 10 loans or 10,000, the platform scales with your firm seamlessly.' },
    { icon: <Globe className="w-6 h-6" style={{ color: 'var(--accent-emerald)' }} />, title: 'Miami-Native', description: "Built by and for South Florida's unique real estate lending ecosystem. We understand the market." },
    { icon: <Layers className="w-6 h-6" style={{ color: 'var(--accent-emerald)' }} />, title: 'Full-Stack OS', description: 'Not just a tool — a complete operating system for your lending business, from origination to servicing.' },
  ];
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black leading-tight text-foreground uppercase tracking-tight mb-4">
            Why <span style={{ color: 'var(--accent-emerald)' }}>Fundex</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-20">
          {reasons.map((reason, i) => (
            ...
            >
              ...
              <p className="font-body text-muted-foreground leading-relaxed mb-4">{reason.description}</p>
              <span className="inline-flex items-center gap-2 font-body text-sm font-semibold opacity-0 group-hover:opacity-100 gentle-animation" style={{ color: 'var(--accent-emerald)' }}>
