...
export function CompanyTopbar({ userName, userInitials }: CompanyTopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-stone-100 bg-white/60 backdrop-blur-md font-sans">
      <div className="mx-auto flex h-[60px] max-w-screen-2xl items-center justify-between px-5 md:px-8">
        ...
        <div className="flex items-center gap-3">
          <Link href="/company" className="flex items-center gap-2.5">
            ...
            <span className="hidden font-display text-lg font-semibold text-stone-900 sm:block">
              Fundex
            </span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden items-center gap-2.5 md:flex">
            <Avatar className="h-8 w-8">
              <AvatarFallback className="bg-fundex-gold/20 text-xs font-semibold text-fundex-forest">
                {userInitials}
              </AvatarFallback>
            </Avatar>
