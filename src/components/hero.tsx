            ...
            <div className="hidden md:flex items-center space-x-8 flex-1 justify-center">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className={`font-sans font-medium gentle-animation hover:scale-105 whitespace-nowrap ${
      ...
      <motion.div
        ...
        <div className="max-w-3xl">
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black leading-[0.95] tracking-tight text-white uppercase">
            ...
            <span className="block">for <span style={{ color: 'var(--primary)' }}>Private</span></span>
            <span className="block" style={{ color: 'var(--primary)' }}>Credit</span>
          </h1>
          <p className="mt-4 font-sans text-lg sm:text-xl text-white/80 max-w-lg">
            yoooo.
          </p>
        </div>
      </motion.div>
