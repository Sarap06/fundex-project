  ...
  const layers = [
    {
      ...
      cards: [
        { icon: <Lock className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Auth & Permissions', description: 'SSO, role-based access, and team management across your entire organization.' },
        { icon: <BarChart3 className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Analytics Engine', description: 'Real-time data pipelines powering dashboards, reports, and automated alerts.' },
        { icon: <Settings className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Infrastructure', description: 'Cloud-native architecture with 99.9% uptime, automatic scaling, and enterprise security.' },
      ],
    },
    {
      label: 'Firm Layer',
      ...
      cards: [
        { icon: <FileText className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Deals & Contracts', description: 'End-to-end deal pipeline management, term sheets, and contract lifecycle tracking.' },
        { icon: <Users className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Team Collaboration', description: 'Shared workspaces, task assignments, and internal communication tools for your lending team.' },
        { icon: <Building2 className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Loan Servicing', description: 'Payment processing, escrow management, and automated borrower communications.' },
      ],
    },
    {
      ...
      cards: [
        { icon: <Eye className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Investor Dashboards', description: 'White-labeled portals giving investors real-time visibility into their positions and returns.' },
        { icon: <Layers className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Portfolio & Positions', description: 'Comprehensive position tracking, NAV calculations, and distribution waterfalls.' },
        { icon: <BarChart3 className="w-5 h-5" style={{ color: 'var(--primary)' }} />, title: 'Reporting & Statements', description: 'Automated K-1s, monthly statements, and custom reporting for LP communications.' },
      ],
    },
  ];
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black leading-tight text-foreground uppercase tracking-tight mb-4">
            The OS <span style={{ color: 'var(--primary)' }}>Layers</span>
          </h2>
            ...
            <motion.div key={layer.label} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: li * 0.15 }}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-xs text-muted-foreground">— {layer.sublabel}</span>
                </div>
                <div className="h-px flex-1 bg-border" />
              </div>
